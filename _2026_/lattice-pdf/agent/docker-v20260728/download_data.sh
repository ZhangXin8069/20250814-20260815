#!/bin/bash
#=============================================================================
# Download SNSC data for docker-v20260726 validation pipeline (local/Docker environment)
#
# Usage:
...
PERAMBULATOR_BASE="/public/group/lqcd/sunpeng/mom_smear_perambulators/beta6.20_mu-0.2770_ms-0.2400_L24x72/output_dir_data/mz2_my0_mx0"
...
# ---- Step 1: Eigen system ----
log_step "Step 1/4: Eigenvectors & Eigenvalues (shared across all confs)"

download_file "${EIGENVECTOR}"
download_file "${EIGENVALUE}"
...
echo "  ├── sunpeng/"
echo "  │   ├── eigen_vector/"
echo "  │   │   ├── beta6.20_..._cfg_48000.eigenvector.npy"
echo "  │   │   └── beta6.20_..._cfg_48000.eigenvalue.npy"
echo "  │   └── mom_smear_perambulators/"
echo "  │       └── beta6.20_..._L24x72/output_dir_data/mz2_my0_mx0/"
for conf_id in "${CONF_IDS[@]}"; do

#!/usr/bin/env python3
"""
Shared utilities for the docker-v20260730 GPU-accelerated pipeline (single precision).

CHANGES from v20260729:
  - New data paths: per-config eigenvectors, per-config perambulators (light/)
  - Eigenvectors: binary LE f8 per time slice → (Nev, Nv, Nc) complex
  - Perambulators: (Nspin, Nev_snk, Nt, Nev_src) complex per (tsrc, dsrc) file

...
共 10 个组态（6250, 6450, 6650, 6850, 7050, 7250, 7450, 7650, 7850, 8050），
计算精度 complex64。
\end{abstract}
...
\midrule
    proton & $P={P0}$ & 1.118 ± 0.008 & 1.000 & $[6,12]$ & 6.0 \\
    proton & $P={P2}$ & 1.559 ± 0.018 & 1.488 & $[6,12]$ & 6.0 \\
    pion & $P={P0}$ & 0.286 ± 0.002 & 0.300 & $[5,18]$ & 13.0 \\
    pion & $P={P2}$ & 1.178 ± 0.187 & 1.022 & $[2,8]$ & 3.0 \\
\bottomrule
\end{tabular}
\end{table}
...
粒子 & 动量 & $R(\tau{\approx}4)$ \\
\midrule
    proton & $P={P0}$ & $+0.1338 \pm 0.0122$ \\
    proton & $P={P2}$ & $-0.0039 \pm 0.0159$ \\
    pion & $P={P0}$ & $-0.9651 \pm 0.0016$ \\
    pion & $P={P2}$ & $+0.3590 \pm 2.6712$ \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
    0 & $-20.270$ & $-1773847648.598$ & $9.078$ & $0.38$ \\
    4 & $-5.099$ & $8593573.121$ & $7.883$ & $0.091$ \\
    8 & $9.949$ & $7101986.347$ & $8.978$ & $0.11$ \\
    12 & $-2.931$ & $-23114662676207.895$ & $11.642$ & $0.75$ \\
    16 & $19.587$ & $-1361942.601$ & $6.521$ & $0.23$ \\
    20 & $14.612$ & $-8189018.051$ & $7.034$ & $0.12$ \\
\bottomrule
\end{tabular}
\end{table}
...
\section{讨论与展望}
当前运行使用单精度 (complex64)、$\Nev=100$、$\Nconf=10$。
